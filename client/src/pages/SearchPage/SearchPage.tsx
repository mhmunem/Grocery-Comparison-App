        ...
        <IonHeader>
          <IonToolbar className="toolbar" color="primary">
            <div className="title-center">
              <IonImg src="680logocropped.png" alt="App Logo" className="headerLogo" />
            </div>
            <IonSearchbar
              value={query}
        ...
        <IonContent>
          ...
          <div className="sortDropdown-container" ref={dropdownRef}>
            ...
            >
              <span className="sortDropdown-selectedLabel">
                {sortValue === 'lowest-highest price'
                  ? 'Lowest-Highest Price'
                  : sortValue === 'highest-lowest price'
            ...
            <div className={`sortDropdown-menu ${isDropdownOpen ? 'open' : ''}`} tabIndex={-1}>
              {[
                ...
                { label: 'Lowest-Highest Price', value: 'lowest-highest price' },
                { label: 'Highest-Lowest Price', value: 'highest-lowest price' },
              ].map((opt) => (
                <div
                  key={opt.value}
          ...
          {loading ? (
            ...
            <div className="grid-container">
              <IonGrid>
                <IonRow>
                  {sortedAndFilteredProducts.slice(startIndex, startIndex + itemsPerPage).map((product) => (
                    <IonCol
                      size="6"
                      size-sm="4"
                      size-md="4"
          ...
          {!loading && sortedAndFilteredProducts.length > itemsPerPage && (
            <PaginationControls
